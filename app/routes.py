...
from app.backend.fillscript import initialDispense
...
def index():
    ...
    if request.method == 'POST':
        ...
        initialDispense(int(form.pump1.data), 'w')
        dispense(int(form.pump0.data), 'q')
        dispense(int(form.pump2.data), 'e')
        dispense(int(form.pump3.data), 'r')
        dispense(int(form.pump4.data), 't')
